<template>
  <div class="oswald-font">
      ...
      <v-container>
        <v-row class="bio-table content-container">
          <v-col class="bio-table-col-1" col="2" lg="2" md="2" sm="6" cols="6">
            ...
            >
            <v-card class="pa-2 dark_1" flat tile style="color: #7af6d0"
              >Date of Birth</v-card
            >
            <v-card class="pa-2 dark_1" flat tile style="color: #7af6d0"
              >Nationality</v-card
            >
            <v-card class="pa-2 dark_1" flat tile style="color: #7af6d0"
              >Spoken Languages</v-card
            >
          </v-col>
    ...
    <div class="cover content-container">
      <h1>Cover Letter</h1>
      <v-container class="cover-content">
        <div v-html="coverLetterContent"></div>
      </v-container>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    scrollDown: function () {
      let container = this.$el.querySelector('.bio');
